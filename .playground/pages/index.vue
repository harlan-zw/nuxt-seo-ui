...
import {definePageMeta, defineBreadcrumbItems, ref} from '#imports'
...
<div>
  ...
  <UButton @click="toggleHideCurrent">Hide Current - {{ hideCurrent }}</UButton>
    <UButton @click="toggleHideSeparator">Hide Separators - {{ hideSeparator }}</UButton>
